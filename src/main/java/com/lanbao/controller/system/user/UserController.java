package com.lanbao.controller.system.user;
...
import com.lanbao.base.ResultGrid;
import com.lanbao.controller.BaseController;
import com.lanbao.entity.Role;
import com.lanbao.entity.User;
import com.lanbao.service.system.menu.MenuService;
import com.lanbao.service.system.role.RoleService;
import com.lanbao.service.system.user.UserService;
import com.lanbao.utils.AppUtil;
import com.lanbao.utils.Const;
import com.lanbao.utils.FileDownload;
import com.lanbao.utils.FileUpload;
import com.lanbao.utils.GetPinyin;
import com.lanbao.utils.Jurisdiction;
import com.lanbao.utils.ObjectExcelRead;
...
public class UserController extends BaseController {
	...
	public ModelAndView toUserList(){
		...
		mv.setViewName("information/demo/Table/simpleTable");
		return mv;
	}
	
	@RequestMapping(value="/getUserList")
	@ResponseBody
	public ResultGrid getUserList(HttpServletRequest req, HttpServletResponse res){ 
		res.setCharacterEncoding("UTF-8");
		res.setContentType("text/html;charset=UTF-8");
		//List<User> list  =  userService.getUserLists();
		List<User> list= new ArrayList<User>(); 
		String dd = JSONArray.fromObject(list).toString();
		System.out.println("dd"+dd);
		String str = "{\"total\":"+list.size()+",\"rows\":"+dd+"}"; 
		ResultGrid rg = new ResultGrid();
		rg.setTotal(list.size());
		rg.setRows(list);
		return rg;
	}
